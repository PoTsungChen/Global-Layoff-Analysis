...
4. **Company stage vs percentage layoffs**: While Public companies accounted for the highest total volume of layoffs, Seed to Series B firms experienced the most severe workforce reductions by percentage, suggesting that early-stage ventures lack the capital buffers therefore are more sensitive to prolonged macroeconomic volatility, leading to near-total liquidations during funding droughts.
